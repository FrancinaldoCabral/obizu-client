...
import { DiscussionAdminComponent } from './discussion-admin/discussion-admin.component'
...
export const routes: Routes = [
    ...
    { path:'admin/discussion', title:'Problemas', component: DiscussionAdminComponent },
